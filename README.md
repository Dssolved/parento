...
Указатель по всем документам — `docs/README.md`. Кратко:

- `docs/current-state.md` - **начинать отсюда**: состояние проекта, что требует ручных действий, известные риски.
- `docs/architecture.md` - структура кода, модель данных, ключевые механики.
- `docs/decisions.md` - причины неочевидных технических решений.
- `docs/supabase-migrations.md` - порядок миграций и проверка, что уже накатано на базу.
- `docs/project-overview.md` - подробный обзор продукта, бизнес-логики и roadmap.
- `docs/qa-checklist.md` - чеклист ручной проверки пользовательского пути и админки.

Контекст для ассистента — `CLAUDE.md` в корне репозитория.
